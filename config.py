...
class SpoonacularService:
    ...
    def _check_key(self):
        ...
        if not hasattr(self, "api_key") or not self.api_key:
            ...
            print(f"Spoonacular API Key loaded: {self.api_key[:5]}...")  # Debug logging

    def search_recipes(self, query: str, diet: Optional[str] = None, intolerances: Optional[List[str]] = None, 
                      cuisine: Optional[str] = None, max_results: int = 10) -> Dict[str, Any]:
        """
        ...
        Returns:
            A dictionary with recipe data or an error message.
        """
        ...
        try:
            ...
            return {"error": f"Error fetching recipes: {e}"}
    ...
    def get_nutritional_info(self, recipe_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": f"Error fetching nutritional data: {e}"}
    ...
    def generate_meal_plan(self, time_frame: str = "day", target_calories: Optional[int] = None,
        ...
        try:
            ...
            return {"error": f"Error generating meal plan: {e}"}
...
def spoonacular_tool(query: str, tool_context: ToolContext) -> Dict[str, Any]:
    """
    ...
    Returns:
        The updated state with recipe data.
    """
    ...
    tool_context.state["recipes"] = result.get("recipes", [])
    return result